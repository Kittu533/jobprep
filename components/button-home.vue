...
.bg::before {
    ...
    /* Replace purple shadow with blue */
    box-shadow: -7px 6px 0 0 rgb(33 118 174 / 40%),
        -14px 12px 0 0 rgb(33 118 174 / 30%), -21px 18px 4px 0 rgb(33 118 174 / 25%),
        -28px 24px 8px 0 rgb(33 118 174 / 15%),
        -35px 30px 12px 0 rgb(33 118 174 / 12%),
        -42px 36px 16px 0 rgb(33 118 174 / 8%),
        -56px 42px 20px 0 rgb(33 118 174 / 5%);
}
...
.content {
    ...
    background: linear-gradient(to bottom,
            var(--blue-300) 0%,
            var(--blue-400) 100%);
    box-shadow: inset -2px 12px 11px -5px var(--blue-200),
...
.button:active .bg::before {
    ...
    /* Replace purple shadow with blue */
    box-shadow: -7px 6px 0 0 rgb(33 118 174 / 40%),
        -14px 12px 0 0 rgb(33 118 174 / 25%), -21px 18px 4px 0 rgb(33 118 174 / 15%);
}

.button:active .content {
    box-shadow: inset -1px 12px 8px -5px rgba(33, 118, 174, 0.4),
